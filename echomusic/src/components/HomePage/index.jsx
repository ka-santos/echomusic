        ...
        <footer className="footer">
          <div className="container">
            <div className="footer-content">
              <div className="footer-brand">
                <div className='brand'>
                  ...
                  <span className="brand-name">EchoMusic</span>
                </div>
                <p className="footer-description">Conectando pessoas através da música desde 2024</p>
              </div>


              <div className="footer-links">
                <div className="link-group">
                  <h4 className="link-title">Produto</h4>
                  <ul className="links">
                    <li>
                      <a href="#">Recursos</a>
                    </li>
                ...
                <div className="link-group">
                  <h4 className="link-title">Empresa</h4>
                  <ul className="links">
                    <li>
                      <a href="#">Sobre Nós</a>
                    </li>
                ...
                <div className="link-group">
                  <h4 className="link-title">Suporte</h4>
                  <ul className="links">
                    <li>
            ...
            <div className="footer-bottom">
              <p className="copyright">© 2025 EchoMusic. Todos os direitos reservados.</p>
